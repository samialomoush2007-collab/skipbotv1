...
"""
                        ...
                        # معالجة أمر /نص
                        if inPuTMsG.strip().startswith('/نص '):
                            # التحقق من أن المرسل هو المالك فقط
                            if str(uid) != str(BOT_OWNER_UID):
                                return

                            # تعريف النصوص المسجلة محلياً داخل الأمر
                            SAVED_MESSAGES = {
                                "1": "هههههههههه يا سيدي خير خير خير خير بعين الـٓله ههههههههههههه اه اه اه سمعت عن الموضوع اه ههههههههههه والـِله مشكلة هاي يا حج ههههههههههه قالولي اه قالولي هههه ان شاء الُـله ان شاء الُِله ان شاء اُلـله خير خير ماشي تمام تمام طيب طيب طيب اه طيب ماشي هههههههههههههه لعله خير يا سيدي هههههههههههههه هي الدنيا هيك اه والله هههههههههههه منتا عارف وضع الكوكب يعني ههههههههههه ان شاء الـٕله يا سيدي تمام تمام حبيبي حبيبي بوصل ان شاء الله ءه ءه ءه هلا هلا هههه تمام تمام سء سء سلام",
                                "2": "هههههههههههههههههههههههههههههههههههههه وربي تصير تصير معليك تصير تصير تصير والـِله تصير تصير وربي تصير تصير معليك تصير تصير تصير والـِله تصير تصير وربي تصير تصير معليك تصير تصير والـِله تصير تصير وربي تصير معليك تصير تصير تصير تصير والـِله تصير وربي تصير تصير معليك تصير تصير تصير والـِله تصير تصير وربي تصير تصير معليك تصير تصير تصير والـِله تصير تصير يولد وربي تصير معليك تصير تصير تصير تصير والـِله تصير تصير وربي تصير معليك تصير تصير تصير تصير تصير والـِله تصير",
                                "3": "حصل خير - مردها تزين يارجال فتره وتعدي يارجال - تصير - صارت معي وانا اخوك - ربك يحلها - فتره وتزين لعلها خيره حصل خير - مردها تزین یارجال - فتره وتعدي يارجال - تصير - صارت معي وانا اخوك - ربك يحلها - فتره وتزين - لعلحصل خیر - مردها تزین یارجال - فتره وتعدي يارجال - تصير - صارت معي وانا اخوك - ربك يحلها - فتره وتزين لعلها خيره حصل خير - مردها تزين يارجال - فتره وتعدي يارجال - تصير - صارت معي وانا اخوك - ربك يحلها - فتره وتزين - لعل حصل خير - مردها تزين يارجال - فتره وتعدي يارجال - تصير - صارت معي وانا اخوك - ربك يحلها - فتره وتزين - لعلها خيره حصل خير - مردها تزين يارجال - فتره وتعدي يارجال - تصير - صارت معي وانا اخوك ربك يحلها فتره وتزين لعل حصل خير - مردها تزین"
                            }

                            parts = inPuTMsG.strip().split()
                            if len(parts) >= 2:
                                msg_key = parts[1]
                                message = SAVED_MESSAGES.get(msg_key)
                                if message:
